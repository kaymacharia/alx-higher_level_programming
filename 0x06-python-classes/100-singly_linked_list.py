#!/usr/bin/python3
"""This module includes a class that defines a square.
Within the Square class, each object is created by the
init method, which initializes a private instance variable
named __size. This variable is set to the value passed as an
argument. Additionally, the method checks whether the size
argument contains a valid value.
"""
